...
typedef size_t (*t_funcion_hash)(const void *clave,size_t len);

typedef struct {
  void* table_map;
  size_t capacidad_maxima;
  t_funcion_hash funcion_hash;
  t_lista indice_claves;
  accion_diccionario act;
  comparar_diccionario cmp;
  comparar_lista cmp_indice;
}t_diccionario;
